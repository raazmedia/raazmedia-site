...
},{"./modules/off-canvas":2}],2:[function(require,module,exports){
var $ = require('jquery');
class OffCanvas {
	constructor() {
		this.button = $('.button');
